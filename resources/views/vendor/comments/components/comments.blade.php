...
@else
    <div class="card mb-5">
        <div class="card-body">
            {{-- <h5 class="card-title text-uppercase">@lang('comments::comments.authentication_required')</h5> --}}
            <small class="card-text d-block">@lang('comments::comments.you_must_login_to_post_a_comment')</small>

            <a href="{{ route('login') }}" class="btn btn-sm btn-primary text-uppercase mt-3">
